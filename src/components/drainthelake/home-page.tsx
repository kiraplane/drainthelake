import {
  DrainTheLakeMobileMenu,
  DrainTheLakeRouteSidebar,
} from '@/components/drainthelake/wiki-navigation';
...
export function DrainTheLakeHomePage() {
  ...
  return (
    <div className="bg-[#f4f7f5] text-slate-950">
      <JsonLd data={jsonLd} />
      <section className="border-slate-900/10 border-b">
        <Container className="px-4 py-8 lg:py-10">
          <div className="overflow-hidden rounded-lg border border-slate-900/10 bg-[linear-gradient(135deg,#f4f8f6_0%,#edf4f1_52%,#ffffff_100%)] p-5 shadow-sm md:p-7">
            <div className="grid items-center gap-7 lg:grid-cols-[minmax(0,1fr)_minmax(360px,0.76fr)]">
              <div className="min-w-0">
                <div className="mb-4 flex max-w-full flex-wrap items-center gap-2">
                  <Badge className="max-w-full shrink whitespace-normal bg-teal-700 text-left text-white leading-5">
                    Roblox incremental simulator
                  </Badge>
                  <Badge
                    variant="outline"
                    className="max-w-full shrink whitespace-normal border-slate-900/15 bg-white/70 text-left text-slate-700 leading-5"
                  >
                    Codes, routes, tokens, depth
                  </Badge>
                </div>
                <h1 className="font-display text-3xl font-black tracking-normal sm:text-4xl md:text-6xl">
                  Drain the Lake Wiki
                </h1>
                <p className="mt-4 max-w-3xl text-lg text-slate-700 leading-8">
                  Plan the bucket loop, tokens, Skill Tree upgrades, depth
                  pushes, badges, codes status, and the phone ending for Drain
                  the Lake on Roblox.
                </p>
                <div className="mt-5 grid gap-3 sm:flex sm:flex-wrap">
                  ...
                  <Button
                    asChild
                    variant="outline"
                    className="w-full border-teal-700 bg-white text-teal-800 hover:bg-teal-50 sm:w-auto"
                  >
                  ...
                  <Button
                    asChild
                    variant="outline"
                    className="w-full border-slate-900/15 bg-white text-slate-800 hover:bg-slate-50 sm:w-auto"
                  >
                    <a
      ...
      <Container className="px-4 py-8 lg:py-10">
        <DrainTheLakeMobileMenu currentPath="/" />
        <div className="grid items-start gap-8 lg:grid-cols-[minmax(0,1fr)_264px]">
          ...
          <DrainTheLakeRouteSidebar currentPath="/" />
        </div>
      </Container>
    </div>
  );
